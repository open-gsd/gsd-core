...
const PROFILES = [
  {
    ...
    color: 'cyan',
    tools:
      'Read, Write, Bash, Grep, Glob, Skill, WebSearch, WebFetch, mcp__context7__*, mcp__plugin_context7_context7__*, mcp__firecrawl__*, mcp__exa__*, mcp__tavily__*, mcp__ref__*, mcp__jina__*, mcp__perplexity__*, mcp__serply__*',
    requiredIncludes: [
  ...
  },
  {
    ...
    color: 'cyan',
    tools:
      'Read, Write, Edit, Bash, Grep, Glob, Skill, WebSearch, WebFetch, mcp__context7__*, mcp__plugin_context7_context7__*, mcp__firecrawl__*, mcp__exa__*, mcp__tavily__*, mcp__ref__*, mcp__jina__*, mcp__perplexity__*, mcp__serply__*',
    requiredIncludes: [
      '@~/.claude/gsd-core/references/research-documentation-lookup.md',
      '@~/.claude/gsd-core/references/research-philosophy.md',
      '@~/.claude/gsd-core/references/research-verification-protocol.md',
