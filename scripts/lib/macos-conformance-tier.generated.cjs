...
module.exports = {
  ...
  "tests/opencode-v2-worktree-provisioner.test.cjs",
  ...
  "tests/quick-batch-v2-lock.test.cjs",
  ...
  "tests/worktree-merge-one-v2.test.cjs",
