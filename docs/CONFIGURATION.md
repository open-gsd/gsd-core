...
| `serply_search` | boolean | `true`/`false` | auto-detected | Override auto-detection of Serply search API availability. When unset, GSD checks for `SERPLY_API_KEY` env var or `~/.gsd/serply_api_key` file |
