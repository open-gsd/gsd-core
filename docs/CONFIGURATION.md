...
| `workflow.background_dispatch` | boolean | `true` | Allows opting out of backgrounding the executor subagents, which prevents `run_in_background: true` from terminating one-shot sessions early. Added in #3159 |
