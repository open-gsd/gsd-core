...
| [1990-onboard-projection-module.md](1990-onboard-projection-module.md) | Onboard Projection Module owns deterministic brownfield repo-state detection and onboarding route selection | Proposed |
