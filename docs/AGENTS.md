...
**Key behaviors:**
- **Adversarial stance / "The Auditor" (#1578):** holds an objective auditor persona with explicit BLOCK/FLAG/PASS tiers and an anti-capitulation rule (does not soften a verdict to match the author's framing) — supplying the verdict-producing critic stance the UI checker previously lacked.
