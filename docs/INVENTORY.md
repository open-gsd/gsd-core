...
| `worktree-path-safety.md` | Executor path guards: supplied-root pin (step 0p, #4254; embedded at dispatch), protected/default HEAD (step 0, #3819), cwd-drift sentinel (step 0a, #3097), and absolute-path containment (step 0b, #3099); includes root normalization and the pinned-superproject submodule contract. |
