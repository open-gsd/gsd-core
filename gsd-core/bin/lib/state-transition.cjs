...
function mutateCurrentPositionFirstTime(body, intent, today, updated) {
    const section = (0, markdown_sectionizer_cjs_1.collectSection)(body, (h) => h.level === 2 && /^current\s+position$/i.test(h.text));
    if (section === null)
        return body;
    ...
    return (0, markdown_sectionizer_cjs_1.replaceSection)(body, section, sectionBody);
}
/**
