...
- Load files the skill references as needed during **integration checking**.
- Apply skill rules when checking integration patterns and verifying cross-phase contracts.
