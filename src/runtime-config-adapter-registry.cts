...
const REGISTRY: Record<string, Readonly<RegistryEntry>> = Object.freeze({
  ...
  commandcode: Object.freeze({ installSurface: 'profile-marker-only',  writesSharedSettings: false, finishPermissionWriter: null       } as const),
});
...
/** The complete set of 18 supported runtimes for config-adapter dispatch. */
