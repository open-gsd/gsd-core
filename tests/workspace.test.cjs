...
describe('workspace command files', () => {
  ...
  test('new-workspace workflow exists', () => {
    ...
    assert.ok(
      ...
      'expected init new-workspace (CJS) or gsd-tools query init.new-workspace'
    );
  ...
  test('list-workspaces workflow exists', () => {
    ...
    assert.ok(
      ...
      'expected init list-workspaces or gsd-tools query init.list-workspaces'
    );
  });
  ...
  test('remove-workspace workflow exists', () => {
    ...
    assert.ok(
      ...
      'expected init remove-workspace or gsd-tools query init.remove-workspace'
    );
