...
describe('install.js exports multi-select runtime metadata', () => {
  ...
  const expectedRuntimes = [
    ...
    'copilot', 'cursor', 'gemini', 'hermes', 'kilo', 'opencode', 'qoder',
    'qwen', 'trae', 'windsurf',
  ];
  ...
  test('prompt lists Hermes Agent (10), Qwen Code (13), Trae (14), Qoder (16), and All (17)', () => {
    ...
    assert.ok(/\b16\)\s*Qoder\b/.test(prompt),
      'prompt lists Qoder as option 16');
