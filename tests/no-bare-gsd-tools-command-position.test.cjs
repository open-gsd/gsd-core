...
const PROSE_ALLOWLIST = [
  ...
  { file: 'agents/gsd-roadmapper.md', line: 657, reason: 'parenthetical "e.g." naming SDK queries a user *could* run; not an agent instruction (#4134 shifted it from 647: the H1 template section added above moved the line, the mention is unchanged)' },
  { file: 'agents/gsd-intel-updater.md', line: 37, reason: 'cross-platform note names the `gsd-tools intel <subcommand>` CLI surface descriptively ("CLI invocations go through..."); not an agent instruction' },
  { file: 'gsd-core/workflows/execute-plan.md', line: 420, reason: 'describes the downstream SDK validation step (`validated downstream by ...`); names the mechanism, does not instruct the agent to type it (#4834 shifted it from 419: the delegation @-include replaced the inline preamble above it, the mention is unchanged)' },
  ...
  { file: 'agents/gsd-intel-updater.compact.md', line: 32, reason: 'compact variant of the already-allowlisted gsd-intel-updater.md:37 cross-platform note; same descriptive mention' },
  { file: 'agents/gsd-roadmapper.compact.md', line: 358, reason: 'compact variant of the already-allowlisted gsd-roadmapper.md:657 parenthetical; same descriptive mention' },
];
