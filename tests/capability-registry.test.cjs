...
const RUNTIME_IDS = [
  ...
  'codebuddy', 'cline', 'kimi', 'mimo', 'commandcode', 'windsurf',
];
...
describe('ADR-1016 phase 5a: all 18 runtimes in registry index', () => {
  let registry;

  test('loadAndValidate + buildRegistry produces runtimes index with 18 entries', () => {
    ...
    assert.strictEqual(runtimeKeys.length, 18, 'Expected 18 runtime entries, got: ' + runtimeKeys.join(', '));
